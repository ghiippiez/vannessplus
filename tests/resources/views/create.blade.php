...
<div class="input-group">
  ...
  <input type="text" class="form-control" name="expected_sal" data-mask>
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="position" value="Position that you are interesting" data-mask>
            </div>
            <br>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="start_date" value="dd/mm/yyyy" data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
            ...
            <!-- /.box-body -->
            <button type="submit" class= "btn btn-block btn-primary btn-lg" name="submit">Add Candidate</button>
          </div>
          <!-- /.box -->
          <!-- /.content-wrapper -->
</section>
